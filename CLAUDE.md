...
Use the canonical workflow's typed pauses, questions, or terminal outcomes for unsupported scope, truth or rights gaps, stale bindings, and unmet gates. A recoverable wait never changes state to `STOP`. Do not create a Claude-specific creative, revision, approval, or audio workflow.
